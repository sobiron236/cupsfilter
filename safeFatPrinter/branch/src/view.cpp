...
void View::createScene()
{
   ...
   for (int i = 0; i < scene->items().size(); ++i){
	...
	if ( item->data(ObjectName).toString()=="Paper"){
	    ...
	    pSimpleItem->setData(ObjectName, "tElem");
	    ...
	    pSimpleItem1->setData(ObjectName, "tElem");
	    ...
	    SimpleItem* pSimpleItem2 = new SimpleItem;
	    pSimpleItem2->setData(ObjectName, "tElem");
	    pSimpleItem2->setPos(100, 40);
	    pSimpleItem2->setText(QStringList()<<"ВТ-4134");
	    pSimpleItem2->setFlag(QGraphicsItem::ItemIsMovable);
	    pSimpleItem2->setParentItem(item);
...
void View::print()
{
    QPrinter printer;
    QString with_t;
    with_t.append("d:\\compl_teml2.pdf");
...
void View::saveToStream()
{
    ...
    QString t_str;
	 ...
	 if (t_str==QString("Border")||t_str==QString("Paper")){
