--DROP FUNCTION reports_set_inv_number (integer,integer);
CREATE OR REPLACE FUNCTION reports_set_inv_number (integer,integer)
  RETURNS INTEGER AS
$BODY$
    DECLARE
     find_id INTEGER;
	...
	-- Ищем значение punkt
	UPDATE  reports SET inv_number = field_val WHERE reports.id = find_id;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION reports_set_inv_number (integer,integer)OWNER TO postgres;
